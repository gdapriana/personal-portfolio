...
export default function ProjectSection ({ view }: { view: string }) {
  ...
  if(projects.length !== 0) {
    if (view === "card") {
      return (
        <div
          className="w-full flex-1 overflow-auto auto-rows-max gap-4 grid mt-4 grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 md:grid-cols-2">
    ...
    return <div className="w-full flex flex-1 justify-center items-center"><LoadingAnimation /></div>
  }
};
